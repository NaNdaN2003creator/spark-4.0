package com.abb.WeatherApp.service;

import com.abb.WeatherApp.dto.*;
...
public class WeatherService {
    ...
    public WeatherResponse getData(String city) {
        //http://api.weatherapi.com/v1/current.json?key=4bd85ee414994c5898e121028251610&q=mumbai
        //agar mujhe apni application se dusri application consume karni hain to uske liye
        // rest template use karna padta hain
